...
| Banxico SIE | Real server-side adapter for USD/MXN FIX `SF43718` | Automatic refresh before page rendering only when persisted history is more than seven days old; manual refresh remains available |
